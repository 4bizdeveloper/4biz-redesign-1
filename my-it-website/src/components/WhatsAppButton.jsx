...
const WhatsAppButton = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 md:bottom-10 md:right-10 z-[999999] flex flex-row-reverse items-center pointer-events-none group">
      <a href={`https://wa.me/${phoneNumber}?text=${message}`} target="_blank" rel="noopener noreferrer" className="wa-space-orb pointer-events-auto" aria-label="Contact on WhatsApp">
        ...
        {/* FROSTED CORE OVERLAY */}
        <div className="absolute inset-0 rounded-full bg-gradient-to-bl from-white/30 to-transparent z-10" />

        <svg viewBox="0 0 32 32" className="w-7 h-7 md:w-8 md:h-8 fill-white relative z-20 transition-all duration-500 group-hover:rotate-12 drop-shadow-[0_0_10px_rgba(255,255,255,0.7)]">
      ...
      <style jsx>{`
        .wa-space-orb {
          ...
          box-shadow: 0 0 40px rgba(0, 242, 255, 0.4), inset 0 0 15px rgba(255, 255, 255, 0.5);
          animation: spin-gradient 4s linear infinite reverse;
        }
        ...
        .wa-space-orb:hover { transform: scale(1.1) translateY(-5px); box-shadow: 0 15px 50px rgba(255, 0, 212, 0.6); }
        ...
        .energy-1 { animation: radiate 3.5s linear infinite; }
        .energy-2 { animation: radiate 3.5s linear infinite 1.2s; }
        .energy-3 { animation: radiate 3.5s linear infinite 2.4s; }
