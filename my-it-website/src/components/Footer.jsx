...
const Footer = () => {
  ...
  // PHYSICS: Using a higher damping and stiffness to stop "jitter" on high-refresh displays
  ...
  // 3D Transforms trigger GPU rendering which eliminates "shaking"
  ...
  return (
    ...
    id="footer"
      ref={footerRef} 
      // added 'contain-paint' and 'backface-hidden' to prevent layout shifting
    ...
    >
      ...
      {/* will-change-transform + translateZ(0) prevents "shaking" during blur calculation */}
      <motion.div 
        style={{ y: y1, translateZ: 0 }} 
        className="absolute top-0 -right-20 w-[300px] md:w-[700px] h-[300px] md:h-[700px] bg-cyan-500/10 blur-[80px] md:blur-[120px] rounded-full pointer-events-none -z-10 will-change-transform" 
      />
      <motion.div 
        style={{ y: y2, translateZ: 0 }} 
        className="absolute bottom-0 -left-20 w-[300px] md:w-[700px] h-[300px] md:h-[700px] bg-purple-600/10 blur-[80px] md:blur-[120px] rounded-full pointer-events-none -z-10 will-change-transform" 
      />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 md:gap-16 lg:gap-8 mb-20 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col items-start space-y-8 md:space-y-10">
            <motion.img 
              ...
              decoding="async" // Loads image without blocking the main thread
              loading="lazy"
              className="h-12 md:h-16 w-auto transition-transform duration-300 transform-gpu"
            />
